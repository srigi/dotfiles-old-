...
KUBE_PS1_PREFIX="%F{185}"
KUBE_PS1_SYMBOL_ENABLE=false
KUBE_PS1_DIVIDER="%K{238}%F{185}${SEGMENT_SEPARATOR}"
KUBE_PS1_COLOR_CONTEXT="%K{185}%F{238}"
KUBE_PS1_COLOR_NS="%F{185}"
KUBE_PS1_SUFFIX="%K{NONE}%F{238}${SEGMENT_SEPARATOR}%f "
...
prompt_end() {
  echo -n " %K{185}%F{$CURRENT_BG}$SEGMENT_SEPARATOR%f"
  CURRENT_BG='NONE'
}
